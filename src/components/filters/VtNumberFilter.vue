...
import VtNumberFilterMore from "./VtNumberFilterMore.vue";
...
const filterMoreRef = ref(null);
const filterString = ref(undefined);
const { t } = useI18n();
...
const filtered = computed(() => {
	return (
		moreFiltered.value === true || (filterString.value && isNaN(filterString.value) === false)
	);
});
			...
			<template #default>
				<div class="vt-filter-wrapper">
					<div class="filter-group">
						...
						<el-input-number v-model="filterString" :placeholder="t('Table.Search')" />
					</div>
					<div class="vt-table__number-filter">
