			...
			rules: [
				{
					...
					data: timeFormat(filterCondition1.value.value)
				},
				{
					field: props.field,
					op: filterCondition2.value.operation,
					data: timeFormat(filterCondition2.value.value)
				}
			]
		};
	} else {
	...
	>
		...
		<div class="flex">
			...
			<div class="flex-initial w-64">
				...
				<el-time-picker v-model="filterCondition1.value" />
			</div>
		</div>
		...
		<div class="flex">
			...
			<div class="flex-initial w-64">
				...
				<el-time-picker v-model="filterCondition2.value" />
			</div>
		</div>
		<template #footer>
			<div class="mr-2">
